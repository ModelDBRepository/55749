function [model] = model_sens(X)
%DEFPATCH1 The model for the sensitivity 
%   [model] = model_v1(X)
%
% X:
%    X(1)    Eh
...
gKs_n  = 800*2*pi*G.dn*G.l*X(3);
gKf_n  = area_n * 15e-9*X(4);
